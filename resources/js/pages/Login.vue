...
<template>
    ...
    >
        ...
        <div class="relative z-10 w-full max-w-sm px-6 py-4 bg-white/95 rounded-2xl shadow-xl text-gray-900">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-3 text-sm">
                ...
                <div>
    <label class="block text-xs text-gray-900 mb-1">Email</label>
    ...
    <span v-if="form.errors.email" class="text-xs text-red-600">
        {{ form.errors.email }}
                ...
                <div>
                    <label class="block text-xs text-gray-900 mb-1">Password</label>
                    <div class="relative">
                        <input
                ...
                <div
                class="cf-turnstile"
                data-sitekey="0x4AAAAAADdPpI-dv0-I8Mzu"
                ></div>
                <input
                type="hidden"
                name="cf-turnstile-response"
